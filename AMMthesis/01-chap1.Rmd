...
ggplot(data = df[1:6,], aes(x=stem_length, y=flower_diam)) + 
  geom_point(color = 'blue') + 
  geom_abline(slope = lin$coefficients[2], intercept = lin$coefficients[1])

ggplot(data = df, aes(x=stem_length, y=flower_diam)) + 
  geom_point(color = 'blue') + 
  geom_abline(slope = lin$coefficients[2], intercept = lin$coefficients[1])
```
