...
$$
Where $s-r$ are the missing cases, $r$ are the respondents, and $\hat N = \sum_{i \in n} \frac{1}{\pi_i}$ is the Horvitz-Thompson estimator \@ref(eq:HTE) of the population size [@horvitz1952generalization].
