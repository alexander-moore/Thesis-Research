...
title: 'Neural Network Methods for Complex Survey Imputation'
...
```{r missingness, echo=FALSE, cache=TRUE, warning = FALSE, fig.cap = "Types of missingness"}
## Make table
library(kableExtra)
library(dplyr)
...
```{r systematic, echo = FALSE, warning = FALSE}
...
knitr::include_graphics("Thesis-Research/images/overfit.png")
```
...
knitr::include_graphics("Thesis-Research/images/badfit.png")
```
...
knitr::include_graphics("Thesis-Research/figure/underfit.png")

```

\@ref(fig:underfit) displays a well-trained model which straddles these extrema and captures the apparent underlying distribution of the data in a general sense by approximating the generative function from which they are drawn, and remains fairly constant under different draws from the same distribution:
...
knitr::include_graphics("Thesis-Research/images/true.png")
```
```{r, echo = FALSE, fig.cap = "The aptly-flexible model has consistent performance on new realizations of the data. The model performing well on data it was not trained on is called generalizability."}
knitr::include_graphics("Thesis-Research/images/stayGood.png")

```

```{r biasvar, echo = FALSE, fig.cap = "http://scott.fortmann-roe.com/docs/BiasVariance.html"}
knitr::include_graphics("Thesis-Research/images/biasvariance.png")
...
knitr::include_graphics("Thesis-Research/images/optimize.png")
```
...
We can see that the loss of a linear regression is a function of $m$ and $c$ given some data which is minimized at $m = 0$ and $c = 0$. The learning rate is the amount that the functions' coefficients are updated as the loss function is optimized.
...
knitr::include_graphics("Thesis-Research/images/network.png")
...
```{r, echo = FALSE}
knitr::include_graphics("Thesis-Research/images/bowl.jpg")
```
...
knitr::include_graphics("Thesis-Research/images/newresults.png")
```
