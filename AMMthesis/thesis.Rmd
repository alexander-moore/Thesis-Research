...
```{r overfit, echo = FALSE, fig.cap = "The overfit model"}
...
```{r overfitre, echo = FALSE, fig.cap = "Overfit model over new data"}
...
```{r underfit, echo = FALSE, fig.cap = "An underfit model"}
...
```{r goodmod, echo = FALSE, fig.cap = "A well-fit model"}
...
```{r feature, echo = FALSE, out.width="80%"}
