...
\section{Simulated Data Experiment}\label{sec:sim_data_exp}
\begin{Shaded}
\begin{Highlighting}[]
...
\{sec:ce\_data\_exp\}}\label{ce-data-experiment-secce_data_exp}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## Real Experiments in CE Data}
\CommentTok{# Documentation:}
\CommentTok{# https://www.bls.gov/cex/pumd_doc.htm#2017}
