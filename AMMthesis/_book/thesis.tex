...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# model selection 2}
\NormalTok{## Adding noise features, new generative function, and }
\CommentTok{# model selection oracle}

\CommentTok{# Compare distributions of mean via different imputation methods on artifical data}
...
\KeywordTok{sum}\NormalTok{(p_tbl}\OperatorTok{$}\NormalTok{p_pi) }\OperatorTok{==}\StringTok{ }\NormalTok{n}\CommentTok{#= 10000 = n}
...
\NormalTok{  df <-}\StringTok{ }\NormalTok{sample_population_by_pi }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{x_1 =}\NormalTok{ p_}\DecValTok{1}\NormalTok{, }\CommentTok{#Since we are not dealing with population p_ anymore}
...
\NormalTok{  #########}
  ...
  \CommentTok{# this is a standard estimator which is done on the full (nonmissing) data to compare}
...
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{oracle_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample) }\OperatorTok{*}\StringTok{ }\KeywordTok{sum}\NormalTok{((}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{pi) }\OperatorTok{*}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{y)}
  
\NormalTok{  #########}
  \CommentTok{# Drop some labels - weighted to high y}
  
\NormalTok{  indices <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(df), .}\DecValTok{2}\OperatorTok{*}\KeywordTok{nrow}\NormalTok{(df), }\DataTypeTok{prob =}\NormalTok{ df}\OperatorTok{$}\NormalTok{y) }\CommentTok{#weights are stdized to 1 by sample()}
\NormalTok{  dropped_obs <-}\StringTok{ }\NormalTok{df[indices,]}
\NormalTok{  reduced_df <-}\StringTok{ }\NormalTok{df[}\OperatorTok{-}\NormalTok{indices,] }\CommentTok{# These have a large differnce: 296 for dropped and 276 for reduced df}
...
\NormalTok{  #########}
  ...
  \CommentTok{# should be unbiased but very large variance. should come forward when gen func change}
\NormalTok{  ## }\AlertTok{NOTE}\NormalTok{ DIFFERENCE OF HAT N RESPOND AND HAT N SAMPLE}
\NormalTok{  hat_N_respondent <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{pi)) }\CommentTok{# largely underestimates the true N}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{pi_naive_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_respondent)}\OperatorTok{*}\KeywordTok{sum}\NormalTok{((}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }\OperatorTok{*}\StringTok{ }
\StringTok{                                                                     }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{y)}
...
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{median_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample) }\OperatorTok{*}\StringTok{ }\KeywordTok{sum}\NormalTok{((}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{pi) }\OperatorTok{*}\StringTok{ }
\StringTok{                                                                     }\NormalTok{imputed_list)}
...
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{lin_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
...
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{lin_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(o_reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{o_reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                         \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(lm_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{o_dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(o_reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{o_reduced_df}\OperatorTok{$}\NormalTok{pi) }
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_pi_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(o_reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{o_reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                           \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_pi_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{o_dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  resamp_df <-}\StringTok{ }\KeywordTok{sample_n}\NormalTok{(}\DataTypeTok{tbl =}\NormalTok{ orig_tbl, }\DataTypeTok{size =} \KeywordTok{nrow}\NormalTok{(orig_tbl), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{weight =}\NormalTok{ weight_vec)}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_resamp_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                                 \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_resamp_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{resamp_dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  partial_y_train <-}\StringTok{ }\NormalTok{y_train[}\OperatorTok{-}\NormalTok{val_indices]}
  ...
  \CommentTok{#range01 <- function(x)\{(x-min(x))/(max(x)-min(x))\}}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_wmse_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(o_reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{o_reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                             \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{o_dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{    partial_x_train,}
\NormalTok{    partial_y_train,}
    \DataTypeTok{epochs =} \DecValTok{300}\NormalTok{, }\CommentTok{#high variance; study further}
    \DataTypeTok{verbose =} \DecValTok{0}\NormalTok{,}
    \DataTypeTok{batch_size =} \DecValTok{32}\NormalTok{,  }\CommentTok{#what should this be}
    \DataTypeTok{validation_data =} \KeywordTok{list}\NormalTok{(x_val, y_val)  }
\NormalTok{  )}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_deriv_oracle[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{it) \{}
  ...
  \CommentTok{# Split the CE data into training and testing. Might want some kind of scheme to }
  \CommentTok{# get the right amount of high-pi and low-pi observations in each}
...
\NormalTok{  #########}
  ...
  \CommentTok{# this is a standard estimator which is done on the full (nonmissing) data to compare}
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{oracle_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample) }\OperatorTok{*}\StringTok{ }\KeywordTok{sum}\NormalTok{((}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{pi) }\OperatorTok{*}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{FINCBTAX)}
...
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{pi_naive_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_respondent)}\OperatorTok{*}\KeywordTok{sum}\NormalTok{((}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }\OperatorTok{*}\StringTok{ }
\StringTok{                                                                     }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX)}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{lin_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                           \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(lm_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  x_test <-}\StringTok{ }\NormalTok{dropped_obs_nolab}
  ...
  \ControlFlowTok{if}\NormalTok{(testing)\{}
    \CommentTok{# Intentionally over-train on the training data to find the validation minimum}
\NormalTok{    model <-}\StringTok{ }\KeywordTok{keras_model_sequential}\NormalTok{() }\OperatorTok{%>%}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                          \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_pi_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                             \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_pi_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_wmse_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                               \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_resamp_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                                 \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_resamp_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{resamp_dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\NormalTok{  hat_N_sample <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{df}\OperatorTok{$}\NormalTok{pi)}
\NormalTok{  statistic_tracker}\OperatorTok{$}\NormalTok{nn_deriv_imp_mean[i] <-}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{hat_N_sample)}\OperatorTok{*}\NormalTok{(}\KeywordTok{sum}\NormalTok{(reduced_df}\OperatorTok{$}\NormalTok{FINCBTAX }\OperatorTok{/}\StringTok{ }\NormalTok{reduced_df}\OperatorTok{$}\NormalTok{pi) }
                                                                \OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(nn_y_hat }\OperatorTok{/}\StringTok{ }\NormalTok{dropped_obs}\OperatorTok{$}\NormalTok{pi))}
...
\KeywordTok{write.csv}\NormalTok{(statistic_tracker, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Alexander}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Documents}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{thesis stat tracker}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{LRepo_8.csv"}\NormalTok{)}
