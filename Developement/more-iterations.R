## Smaller-effort for more iterations
...
for (i in 1:it) {
  ...
  history <- model %>% fit(
    partial_x_train,
    partial_y_train,
    epochs = epo, #high variance; study further
    verbose = 0,
...
write.csv(statistic_tracker, file = "C:\\Users\\Alexander\\Documents\\thesis stat tracker\\test_MOREIT4.csv")
